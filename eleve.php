...
<body>
    <div>
        ...
        <form method="POST" action="logineleve.php">
            <h2 style="color: brown;">email : </h2> <input type="text" name="email" placeholder="votre email" id="email">
            <h2 style="color: brown;">password : </h2> <input type="text" name="password" placeholder="votre password " id="password">
            <br><br><br>

            <button id="button" name="submit">connexion</button>
